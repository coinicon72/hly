...
INSERT INTO `bom` VALUES (9,'2018-08-21 10:03:55',1,5,1);
...
INSERT INTO `formula` VALUES (1,'init',NULL,'2018-08-20 09:02:10',NULL,1,1);
...
INSERT INTO `formula_item` VALUES (1,1,2),(1,1,3);
...
INSERT INTO `order_item` VALUES (NULL,22,11,1,1),(NULL,40,20,1,2),(NULL,2,1,2,1),(NULL,4,3,2,2),(NULL,6,5,3,2),(NULL,2,1,5,1);
...
INSERT INTO `produce_condition` VALUES (3,5,2,1,4,7,6,1);
...
INSERT INTO `producing_schedule` VALUES (2,1,'2018-08-22 19:00:00',NULL,NULL),(2,2,'2018-08-23 19:00:00',NULL,NULL),(5,1,'2018-08-21 19:00:00','2018-08-22 19:00:00','3');
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='库存变化';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `repo_changing_item` VALUES (2,3,1,0,2),(3,2,3,0,4),(5,3,1,0,2),(5,4,3,0,4),(6,3,3,0,0),(6,4,2,0,0),(7,2,3.4,0,4),(8,2,23,0,0),(8,3,445,0,0),(9,3,2,0,3),(10,1,3,0,4),(11,2,2,0,2);
...
INSERT INTO `repo_changing_reason` VALUES (1,0,1,'采购入库',0),(2,0,1,'盘盈',0),(3,0,1,'过期转入',0),(4,0,1,'其他仓库调入',0),(5,0,-2,'生产领用',1),(6,0,-2,'打板领用',0),(7,0,-2,'车间辅助生产领用',0),(8,0,-2,'盘亏',0),(9,0,-2,'过期转出',0);
...
-- Dump completed on 2018-08-22 13:58:15
