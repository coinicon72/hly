...
INSERT INTO `formula` VALUES (1,'init',NULL,'2018-08-20 09:02:10',NULL,1,6),(2,'refine',NULL,'2018-08-20 09:02:10',NULL,2,6),(3,'init',NULL,'2018-08-23 07:35:20',NULL,1,7);
...
INSERT INTO `formula_item` VALUES (1,1,2),(1,1,3),(0.3,3,3),(0.4,3,4);
...
INSERT INTO `produce_condition` VALUES (3,5,2,1,4,7,6,1),(3,5,2,1,4,7,6,2),(4,6,3,2,5,8,7,3);
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='库存变化';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `repo_changing_item` VALUES (2,3,1,0,2),(3,2,3,0,4),(5,3,1,0,2),(5,4,3,0,4),(6,3,3,0,0),(6,4,2,0,0),(7,2,3.4,0,4),(8,2,23,0,0),(8,3,445,0,0),(9,3,2,0,3),(10,1,3,0,4),(11,2,2,0,2),(12,3,5,0,6),(12,4,1,0,2),(12,6,3,0,0),(12,7,4,0,0);
...
INSERT INTO `repo_changing_reason` VALUES (1,0,1,'采购入库',0),(2,0,1,'盘盈',0),(3,0,1,'过期转入',0),(4,0,1,'其他仓库调入',0),(5,0,-2,'生产领用',1),(6,0,-2,'打板领用',0),(7,0,-2,'车间辅助生产领用',0),(8,0,-2,'盘亏',0),(9,0,-2,'过期转出',0),(11,0,-2,'销售出库',1);
...
-- Dump completed on 2018-08-26 21:55:01
