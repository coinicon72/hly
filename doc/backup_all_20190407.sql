...
INSERT INTO `bom` VALUES (NULL,'2018-12-08 07:40:44',1,2,6),(NULL,'2018-12-08 07:40:44',3,2,7),(9,'2018-08-21 10:03:55',1,5,6),(10,'2018-12-08 07:24:22',1,6,6),(NULL,'2018-12-15 08:56:10',3,7,7),(NULL,'2018-12-15 09:42:55',5,7,13);
...
CREATE TABLE `bom_item` (
  ...
  `order_id` bigint(20) NOT NULL,
  `product_id` bigint(20) NOT NULL,
  PRIMARY KEY (`material_id`,`order_id`,`product_id`),
...
INSERT INTO `bom_item` VALUES (1,0.5,NULL,2,2,6),(1,2,9,2,5,6),(2,1,10,2,6,6),(180,180,NULL,2,7,13),(1,0.5,NULL,3,2,6),(0.9,0.4,NULL,3,2,7),(1,2,9,3,5,6),(2,1,10,3,6,6),(60,60,NULL,3,7,7),(120,120,NULL,3,7,13),(1.2,0.6,NULL,4,2,7),(80,80,NULL,4,7,7);
...
INSERT INTO `collecting_settlement` VALUES (1,1,'2018-07-06 18:31:45',0,NULL,NULL,NULL,1056,NULL,NULL,NULL),(2,1,'2018-07-06 18:45:36',2,NULL,10,'2018-07-21 07:05:40',30,10,'2018-07-24 14:56:30',25),(4,1,'2018-07-20 18:14:11',2,NULL,10,'2018-07-21 07:14:26',1056,10,'2018-07-24 15:08:49',1055),(15,2,'2018-11-10 00:30:47',0,NULL,NULL,NULL,46,NULL,NULL,NULL);
...
CREATE TABLE `collecting_settlement_item` (
  ...
  CONSTRAINT `fk_collecting_settlement_item_settlement` FOREIGN KEY (`settlement_id`) REFERENCES `collecting_settlement` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `collecting_settlement_item` VALUES (1,1),(4,1),(1,2),(4,2),(2,3),(15,5);
...
CREATE TABLE `delivery_sheet` (
  ...
  `delivery_date` datetime NOT NULL COMMENT 'filled in by creator, can’t early than current date',
  `status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0-just created;1-committed (to repo);2-handled (processed)',
  `created_by` int(11) NOT NULL,
  `created_on` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `committed_by` int(11) DEFAULT NULL,
  `committed_on` datetime DEFAULT NULL,
  `delivery_on` datetime DEFAULT NULL COMMENT 'actual delivery date',
  PRIMARY KEY (`id`),
  KEY `fk_delivery_sheet_order` (`order_id`),
  KEY `fk_delivery_sheet_creator_idx` (`created_by`),
  KEY `fk_delivery_sheet_committer_idx` (`committed_by`),
  CONSTRAINT `fk_delivery_sheet_committer` FOREIGN KEY (`committed_by`) REFERENCES `user` (`id`),
  CONSTRAINT `fk_delivery_sheet_creator` FOREIGN KEY (`created_by`) REFERENCES `user` (`id`),
...
INSERT INTO `delivery_sheet` VALUES (2,'d-0001',5,'2018-08-22 00:00:00',2,10,'2018-10-04 00:00:00',10,'2018-11-10 00:00:00','2018-11-10 16:37:12'),(6,'d-0007',5,'2018-08-24 00:00:00',2,10,'2018-10-04 00:00:00',10,'2018-11-09 00:00:00',NULL),(7,'d-0004',5,'2018-11-04 00:00:00',2,10,'2018-11-03 00:00:00',10,'2018-11-04 00:00:00','2018-11-10 16:40:05'),(8,'d-0005',5,'2018-11-03 00:00:00',2,10,'2018-11-04 00:00:00',10,'2018-11-10 00:00:00','2018-11-10 16:31:19'),(9,'d-0008',5,'2018-11-08 00:00:00',2,10,'2018-11-10 00:00:00',10,'2018-11-10 00:00:00',NULL),(10,'d-0011',6,'2018-12-05 00:00:00',1,10,'2018-12-07 00:00:00',10,'2018-12-08 00:00:00',NULL);
...
INSERT INTO `delivery_sheet_item` VALUES (2,5,6,10,1,5.3,'test'),(6,5,6,3,2,3,NULL),(6,5,7,1.2,1,3,NULL),(7,5,6,3,2,2,NULL),(8,5,6,2,1,2,NULL),(9,5,6,2,1,2,NULL),(10,6,6,1,1,3,NULL);
...
INSERT INTO `formula` VALUES (1,'init',NULL,'2018-08-20 09:02:10',NULL,1,6),(2,'refine',NULL,'2018-08-20 09:02:10',NULL,2,6),(3,'init',NULL,'2018-08-23 07:35:20',NULL,1,7),(4,'test','ttt','2018-09-19 10:35:43',NULL,1,4),(5,'e','e','2018-12-15 09:42:14',NULL,1,13);
...
INSERT INTO `formula_item` VALUES (1,1,2),(1,1,3),(0.3,3,3),(0.4,3,4),(1,4,3),(2,4,4),(0.6,5,2),(0.4,5,3);
...
CREATE TABLE `inventory` (
  ...
  `report_by` int(11) NOT NULL COMMENT '清点人',
  `audit_by` int(11) DEFAULT NULL COMMENT '复核人',
  `status` smallint(6) NOT NULL DEFAULT '0' COMMENT '0-created; 1-committed; 2-audited',
  PRIMARY KEY (`id`),
  KEY `fk_inventory_repo_idx` (`repo_id`),
  KEY `fk_inventory_report_by_idx` (`report_by`),
  KEY `fk_inventory_audit_by_idx` (`audit_by`),
  CONSTRAINT `fk_inventory_audit_by` FOREIGN KEY (`audit_by`) REFERENCES `user` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_inventory_repo` FOREIGN KEY (`repo_id`) REFERENCES `repo` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_inventory_report_by` FOREIGN KEY (`report_by`) REFERENCES `user` (`id`) ON UPDATE CASCADE
...
INSERT INTO `order` VALUES (1,NULL,'测试','2018-05-30 19:00:00',NULL,'o-001','2018-05-26 19:00:00',4,0,1042,1),(2,NULL,'test','2018-05-30 00:00:00',NULL,'o-002','2018-05-26 00:00:00',1,0,14,1),(3,NULL,'test again','2018-05-29 19:00:00',NULL,'o-003','2018-05-25 19:00:00',4,1,30,1),(5,46,NULL,'2018-08-06 00:00:00',NULL,'o-1000','2018-08-05 00:00:00',3,1,14.3,2),(6,0,'test','2018-08-24 00:00:00',NULL,'o-0006','2018-08-24 00:00:00',1,0,6,2),(7,0,'f','2018-12-12 00:00:00',NULL,'o-00013','2018-12-14 00:00:00',1,0,13000,2);
...
INSERT INTO `order_item` VALUES (1,6,22,11,NULL),(1,7,40,20,NULL),(2,6,2,1,NULL),(2,7,4,3,NULL),(3,7,6,5,NULL),(5,6,2.3,1,NULL),(5,7,1.2,10,NULL),(6,6,3,2,NULL),(7,7,20,200,NULL),(7,13,30,300,NULL);
...
INSERT INTO `payment_settlement` VALUES (4,0,1,'2018-07-21 21:32:53',42,2,NULL,10,'2018-07-22 10:33:22',10,'2018-07-23 15:42:29',42);
...
INSERT INTO `payment_settlement_item` VALUES (4,3);
...
INSERT INTO `produce_condition` VALUES (3,5,2,1,4,7,6,1),(3,5,2,1,4,7,6,2),(4,6,3,2,5,8,7,3),(3,5,2,1,4,7,6,4),(7,5,8,9,6,3,4,5);
...
INSERT INTO `producing_schedule` VALUES (2,6,'2018-08-22 19:00:00',NULL,'l2'),(2,7,'2018-08-23 19:00:00',NULL,'l3'),(5,6,'2018-08-21 19:00:00','2018-08-22 19:00:00','3'),(6,6,'2018-11-15 18:00:00',NULL,'l1'),(7,7,'2018-12-15 18:00:00','2018-12-18 18:00:00','l5'),(7,13,'2018-12-14 18:00:00',NULL,'8');
...
INSERT INTO `purchasing_order` VALUES (2,'p-0002','2018-06-16 11:00:00',1,0.03,31.44,4,21,0,NULL),(3,'p-0005','2018-07-21 11:00:00',1,0.16,42,1,10,4,'geg'),(5,'p-0007','2018-07-21 11:00:00',1,0.16,14,4,10,0,'ee');
...
CREATE TABLE `repo_changing` (
  ...
  `delivery_id` bigint(20) DEFAULT NULL COMMENT 'delivery sheet id',
  `product_id` bigint(20) DEFAULT NULL,
  ...
  KEY `fk_repo_changing_delivery_idx` (`delivery_id`),
  CONSTRAINT `fk_repo_changing_delivery` FOREIGN KEY (`delivery_id`) REFERENCES `delivery_sheet` (`id`) ON UPDATE CASCADE,
...
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8 COMMENT='库存变化';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `repo_changing` VALUES (1,1,1,0,'2018-05-26 18:48:58',NULL,10,2,NULL,NULL,NULL,NULL,NULL,'test',0,0,0,NULL,NULL,NULL,'rc-1'),(2,1,1,0,'2018-05-26 19:01:27',NULL,10,1,NULL,NULL,NULL,NULL,NULL,'d',0,0,0,NULL,NULL,NULL,'rc-2'),(3,2,1,2,'2018-05-26 19:06:48','2018-05-26 11:00:00',10,4,'t',NULL,NULL,NULL,NULL,'d',0,0,0,21,'2018-06-10 10:07:25','','rc-3'),(4,1,1,0,'2018-06-09 16:05:06',NULL,10,3,'过期',NULL,NULL,NULL,NULL,NULL,0,0,0,NULL,NULL,NULL,'rc-4'),(5,1,1,0,'2018-06-09 16:29:34',NULL,10,3,'dk',NULL,NULL,NULL,NULL,NULL,0,0,0,NULL,NULL,NULL,'rc-5'),(6,1,-1,1,'2018-06-09 16:44:36','2018-06-09 11:00:00',10,5,'生产',NULL,3,NULL,NULL,NULL,0,0,0,NULL,NULL,NULL,'rc-6'),(7,2,-1,2,'2018-06-09 18:37:13','2018-06-09 11:00:00',10,6,'测试',NULL,NULL,NULL,NULL,NULL,0,0,0,21,'2018-06-10 10:08:28','','rc-7'),(8,1,-1,0,'2018-07-13 00:33:11',NULL,10,5,NULL,NULL,NULL,NULL,NULL,NULL,0,0,0,NULL,NULL,NULL,'rc-8'),(9,1,1,2,'2018-07-25 01:03:41','2018-07-25 09:03:41',10,1,'drsg',NULL,NULL,NULL,NULL,NULL,0,0,0,10,'2018-11-25 09:03:35','','rc-10'),(11,1,1,0,'2018-08-21 11:00:00',NULL,10,1,NULL,NULL,NULL,NULL,NULL,NULL,0,0,0,NULL,NULL,NULL,'cr-11'),(12,1,1,0,'2018-08-23 01:13:48',NULL,10,1,'test',NULL,NULL,NULL,NULL,NULL,0,0,0,NULL,NULL,NULL,'cr-0005'),(13,1,1,0,'2018-09-19 01:51:23',NULL,10,1,'ff',5,NULL,NULL,NULL,NULL,0,0,0,NULL,NULL,NULL,'si-0001'),(14,2,-1,1,'2018-11-06 10:00:00','2018-11-06 10:00:00',10,11,'eee',NULL,5,NULL,NULL,NULL,0,0,0,21,NULL,NULL,'d-0005'),(15,2,-1,1,'2018-11-09 00:08:58',NULL,10,11,NULL,NULL,5,6,NULL,NULL,0,0,0,NULL,NULL,NULL,'r-0003'),(38,2,-1,2,'2018-11-09 13:24:38',NULL,10,11,NULL,NULL,5,7,NULL,NULL,0,0,0,10,'2018-11-10 08:39:16','test2','r-0004'),(39,2,-1,2,'2018-11-09 18:10:03','2018-11-09 02:00:00',10,11,NULL,NULL,5,2,NULL,NULL,0,0,0,10,'2018-11-10 08:37:12','test','d-0006'),(40,2,-1,2,'2018-11-09 18:13:40','2018-11-09 02:00:00',10,11,'测试',NULL,5,8,NULL,NULL,0,0,0,10,'2018-11-10 08:23:55','','d-0007'),(41,2,-1,1,'2018-11-09 22:53:38','2018-11-09 02:00:00',10,11,NULL,NULL,5,9,NULL,NULL,0,0,0,NULL,NULL,NULL,'d-0009'),(43,1,-1,0,'2018-12-05 10:00:00',NULL,10,9,NULL,NULL,NULL,NULL,NULL,NULL,0,0,0,NULL,NULL,NULL,'d-0011');
...
CREATE TABLE `repo_changing_item` (
  ...
  CONSTRAINT `fk_repo_changing_item_repo_changing` FOREIGN KEY (`repo_changing_id`) REFERENCES `repo_changing` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `repo_changing_item` VALUES (2,3,1,0,2),(3,2,3,0,4),(5,3,1,0,2),(5,4,3,0,4),(6,3,3,0,0),(6,4,2,0,0),(7,2,3.4,0,4),(8,2,23,0,0),(8,3,445,0,0),(9,1,3,0,4),(11,2,2,0,2),(12,3,5,0,6),(12,4,1,0,2),(12,6,3,0,0),(12,7,4,0,0),(13,1,1,0,1.72414),(13,4,3,0,3.44828),(14,6,3,0,2),(38,6,1,0,1),(39,6,10,0,1),(40,6,2,0,1),(41,6,2,0,0),(43,3,2,0,0);
...
CREATE TABLE `repo_changing_reason` (
  ...
  `order_related` tinyint(4) NOT NULL DEFAULT '0' COMMENT '1 = delivery related; 2 = purching related; 3 = bom related',
  PRIMARY KEY (`id`),
  KEY `fk_repo_changing_repo_idx` (`repo_id`)
...
INSERT INTO `repo_changing_reason` VALUES (1,0,1,'采购入库',2),(2,0,1,'盘盈',0),(3,0,1,'过期转入',0),(4,0,1,'其他仓库调入',0),(5,0,-1,'生产领用',3),(6,0,-1,'打板领用',3),(7,0,-1,'车间辅助生产领用',0),(8,0,-1,'盘亏',0),(9,0,-1,'过期转出',0),(11,0,-1,'销售出库',1);
...
CREATE TABLE `repo_history` (
  ...
  `quantity` float NOT NULL,
  `price` float NOT NULL,
  PRIMARY KEY (`inventory_id`,`material_id`,`repo_id`),
  KEY `fk_repo_history_material` (`material_id`),
  KEY `fk_repo_history_repo_idx` (`repo_id`),
  ...
  CONSTRAINT `fk_repo_history_repo` FOREIGN KEY (`repo_id`) REFERENCES `repo` (`id`) ON UPDATE CASCADE
...
INSERT INTO `repo_item` VALUES (1,1,5,6,'啊'),(1,2,10,3,'fese'),(1,4,4,5,'test'),(2,2,1.4,4,'nowhere'),(2,6,7,1,NULL),(2,7,6,7,'8');
...
CREATE TABLE `repo_snapshot` (
  ...
  `value_in` float DEFAULT NULL,
  `quantity_out` float DEFAULT NULL,
  `value_out` float DEFAULT NULL,
  `quantity` float unsigned NOT NULL,
  `price` float NOT NULL,
  `value` float unsigned NOT NULL,
  PRIMARY KEY (`time`,`repo_id`,`material_id`),
  KEY `fk_repo_item_material` (`material_id`),
  KEY `repo_id` (`repo_id`),
  CONSTRAINT `repo_snapshot_ibfk_1` FOREIGN KEY (`material_id`) REFERENCES `material` (`id`),
  CONSTRAINT `repo_snapshot_ibfk_2` FOREIGN KEY (`repo_id`) REFERENCES `repo` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='库存快照，在每个自然月记录当前库存情况';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `repo_snapshot`
--

LOCK TABLES `repo_snapshot` WRITE;
/*!40000 ALTER TABLE `repo_snapshot` DISABLE KEYS */;
INSERT INTO `repo_snapshot` VALUES ('2018-06-01',1,1,0,0,0,0,3,4,12),('2018-06-01',1,2,0,0,0,0,10,3,30),('2018-06-01',2,2,3,12,3.4,13.6,1.4,4,5.6),('2018-06-01',2,6,0,0,0,0,7,1,7),('2018-11-01',1,1,3,12,0,0,3,4,12),('2018-11-01',1,2,0,0,0,0,10,3,30),('2018-11-01',2,2,0,0,0,0,1.4,4,5.6),('2018-11-01',2,6,0,0,13,13,7,1,7),('2018-12-01',1,1,0,0,0,0,3,4,12),('2018-12-01',1,2,0,0,0,0,10,3,30),('2018-12-01',2,2,0,0,0,0,1.4,4,5.6),('2018-12-01',2,6,0,0,0,0,7,1,7),('2019-02-01',1,1,0,0,0,0,5,6,30),('2019-02-01',1,2,0,0,0,0,10,3,30),('2019-02-01',1,4,0,0,0,0,4,5,20),('2019-02-01',2,2,0,0,0,0,1.4,4,5.6),('2019-02-01',2,6,0,0,0,0,7,1,7),('2019-02-01',2,7,0,0,0,0,6,7,42);
/*!40000 ALTER TABLE `repo_snapshot` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping events for database 'hly'
--
/*!50106 SET @save_time_zone= @@TIME_ZONE */ ;
/*!50106 DROP EVENT IF EXISTS `evt_repo_snapshot` */;
DELIMITER ;;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;;
...
/*!50106 CREATE*/ /*!50117 DEFINER=`hly`@`%`*/ /*!50106 EVENT `evt_repo_snapshot` ON SCHEDULE EVERY 1 MONTH STARTS '2019-01-01 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO call stat_repo_changing_monthly(now()) */ ;;
...
;
  ...
  elseif err = 2 then
	...
	update delivery_sheet d, repo_changing c set d.delivery_on=now() where d.id=c.delivery_id and c.id=cid;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `repo_changing_stat_monthly` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`hly`@`%` PROCEDURE `repo_changing_stat_monthly`(d date)
BEGIN
-- 以参数 d 对应的月初为结束时间，统计前一个月所有仓库的进出汇总
with 
si as (SELECT c.repo_id, ci.material_id, c.type, sum(quantity) q, sum(quantity * price) v FROM hly.repo_changing_item ci join repo_changing c on ci.repo_changing_id=c.id 
where c.execute_date between adddate(date_format(d, '%Y-%m-01'), interval -1 month) and date_format(d, '%Y-%m-01')
and c. type = 1
group by c.repo_id, ci.material_id, c.type),
so as (SELECT c.repo_id, ci.material_id, c.type, sum(quantity) q, sum(quantity * price) v FROM hly.repo_changing_item ci join repo_changing c on ci.repo_changing_id=c.id 
where c.execute_date between adddate(date_format(d, '%Y-%m-01'), interval -1 month) and date_format(d, '%Y-%m-01')
and c. type = -1
group by c.repo_id, ci.material_id, c.type)
select si.repo_id, si.material_id, 1 si, si.q qi, si.v vi, -1 so, ifnull(so.q, 0) qo, ifnull(so.v, 0) vo from si left join so on si.repo_id=so.repo_id and si.material_id=so.material_id
union -- all
select so.repo_id, so.material_id, 1, ifnull(si.q, 0) qi, ifnull(si.v, 0) vi, -1, so.q qo, so.v vo from si right join so on si.repo_id=so.repo_id and si.material_id=so.material_id
;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `stat_repo_changing_monthly` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`hly`@`%` PROCEDURE `stat_repo_changing_monthly`(d datetime)
BEGIN
  DECLARE done int DEFAULT FALSE;
    
  declare s date default adddate(date_format(d, '%Y-%m-01'), interval -1 month);
  declare e date default date_format(d, '%Y-%m-01');
  
  declare t date;
  declare r int;
  declare m bigint;
  declare qi, vi, qo, vo, cq, cp, cv float default 0;
  
 -- select adddate(date_format(d, '%Y-%m-01'), interval -1 month), date_format(d, '%Y-%m-01') into @s, @e;
  
  declare c cursor for 
  with 
si as (SELECT c.repo_id, ci.material_id, c.type, sum(quantity) q, sum(quantity * price) v 
FROM hly.repo_changing_item ci join repo_changing c on ci.repo_changing_id=c.id 
where c.execute_date between s and e
and c. type = 1
group by c.repo_id, ci.material_id, c.type),
so as (SELECT c.repo_id, ci.material_id, c.type, sum(quantity) q, sum(quantity * price) v 
FROM hly.repo_changing_item ci join repo_changing c on ci.repo_changing_id=c.id 
where c.execute_date between s and e
and c. type = -1
group by c.repo_id, ci.material_id, c.type),
rc as (select si.repo_id, si.material_id, 1 si, si.q qi, si.v vi, -1 so, so.q qo, so.v vo 
from si left join so on si.repo_id=so.repo_id and si.material_id=so.material_id
union -- all
select so.repo_id, so.material_id, 1, si.q qi, si.v vi, -1, so.q qo, so.v vo 
from si right join so on si.repo_id=so.repo_id and si.material_id=so.material_id
)
select s, ri.repo_id, ri.material_id, ifnull(rc.qi, 0), ifnull(rc.vi, 0), ifnull(rc.qo, 0), ifnull(rc.vo, 0), ri.quantity cq, ri.price cp, ri.price * ri.quantity cv 
from rc right join repo_item ri on rc.repo_id=ri.repo_id and rc.material_id=ri.material_id
;
  ...
  read_loop: LOOP
    FETCH c INTO t, r, m, qi, vi, qo, vo, cq, cp, cv;

    IF done THEN
      LEAVE read_loop;
    END IF;
    
    -- select t, r, m, qi, vi, qo, vo, cq, cv;
    insert into repo_snapshot values (t, r, m, qi, vi, qo, vo, cq, cp, cv);
...
-- Dump completed on 2019-04-07 11:43:29
